...
export const navigation = [
...

  {
    ...
    subItems: [
      ...
      { label: "Locations", path: "/configurations/locations", navigationCode: "CONFIG_CHART_OF_ACCOUNTS" },
      { label: "Classes", path: "/configurations/classes", navigationCode: "CONFIG_CHART_OF_ACCOUNTS" },
    ]
  },
  {
    label: "Audit Log",
